<?php
	...
	function datewiseExpenseReport($conn, $from, $to){
		$sql = "SELECT * FROM expense where expense_date BETWEEN '$from' AND '$to'";
		$result = mysqli_query($conn, $sql);
		if(!$result){
			echo "Can't retrieve data " . mysqli_error($conn);
			exit;
	...
	function datewiseSalesReport($conn, $from, $to){
		$sql = "SELECT * FROM sales where sdate BETWEEN '$from' AND '$to'";
		$result = mysqli_query($conn, $sql);
		if(!$result){
			echo "Can't retrieve data " . mysqli_error($conn);
			exit;
	...
	function datewisePurchaseReport($conn, $from, $to){
		$sql = "SELECT * FROM purchase where pdate BETWEEN '$from' AND '$to'";
		$result = mysqli_query($conn, $sql);
		if(!$result){
			echo "Can't retrieve data " . mysqli_error($conn);
			exit;
	...
	function datewiseCustomerReport($conn, $from, $to){
		$sql = "SELECT * FROM addtransaction where edate BETWEEN '$from' AND '$to'";
		$result = mysqli_query($conn, $sql);
		if(!$result){
			echo "Can't retrieve data " . mysqli_error($conn);
			exit;

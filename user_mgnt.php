						                  		...
						                  		<div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                     	<div class="form-check">
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="A07"> Purchase
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			  ...
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="A08"> Add Customer
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			  ...
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="A09"> Inventory
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>

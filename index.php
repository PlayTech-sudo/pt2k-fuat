...
<div class="content" style="min-height: calc(100vh - 160px);">
 	...
 	<div class="col-md-6">
	    ...
	    <div class="col-md-6">
		        <div class="card bg-info text-white">
				    ...
				    <h3 class="card-title" align="center">Stock    Update</h3>
					</div>
				</div>
 ...
 ?>
	  ...
	  <?php } ?>
	  	...
	  	<div class="col-md-6">
		      ...
		      <div class="card-header card-header-danger card-header-icon">
		        ...
		        <h3 class="card-title"><?php echo $stock; ?> Ltrs.</h3>
		      </div>
		      <div class="card-footer">
		        ...
		        <a rel="tooltip" href="process/admin/usr_process.php?delgas=<?php echo $gas ?>"  class="btn btn-danger btn-link" title="Delete">
    ...
    <?php $i++;  } ?>
    <?php
 $sql = "SELECT * FROM entry WHERE edate='$edate' ";
					$result = mysqli_query($conn, $sql) or die("cannot retrieve ".mysqli_error($conn));
					$j=0;
					if(mysqli_num_rows($result)>0){
					while($row = mysqli_fetch_array($result)){
   ...
   <?php  } ?>
    <div class="col-md-6">
		      <div class="card bg-info text-white">
				    ...
				    <h3 class="card-title" align="center">Total Fuels</h3>
				    <h3 class="card-title"align="center"><?php echo $i; ?> </h3>
					</div>
				</div>
			</div>
			<div class="col-md-6">
		       <div class="card bg-info text-white">
				    ...
				    <h3 class="card-title" align="center">Total Entries Today </h3>
				    <h3 class="card-title"align="center"><?php echo $j; ?></h3>
					</div>
			    </div>
			 </div>
	  </div>              

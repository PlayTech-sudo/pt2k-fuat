<?php
	...
	if(isset($_POST['fuel'])){
		...
		$sql = mysqli_query($conn,"INSERT INTO `fuel` (id, fdate, ftime, type,stock, price,des) VALUES('".$sl."','".$fdate."','".$ftime."','".$type."', '".$stock."','".$price."','".$des."')") or die("cannot insert".mysqli_error($conn));
	   ...
	   $sl = getsl($conn, "id", "inventory");
		$sql = mysqli_query($conn,"INSERT INTO `inventory` (id,fuel_type,qty,price) VALUES('".$sl."','".$type."', '".$stock."', '".$price."')") or die("cannot insert".mysqli_error($conn));
			  	...
			  	<div class="card-body">
			  		<form name="form7" action="" method="POST">
		          		...
		          		<div class="form-group bmd-form-group">
		            		<input type="text" class="form-control" value="<?php echo $tdate; ?>" required="" placeholder="Date" name="fdate">
		            		<span class="bmd-help">Date</span>
		          		</div>
		        		</div>
		        		<div class="col-md-6">
		          		<div class="form-group bmd-form-group">
		            		<input type="text" class="form-control" value="<?php echo $ttime; ?>" required="" placeholder="Time" name="ftime">
								        		...
								        		<tbody>
								        			...
								        			?>
									          		<tr>
											            ...
											            <td><?php echo $user['fdate']; ?></td>
											            <td><?php echo $user['ftime']; ?></td>

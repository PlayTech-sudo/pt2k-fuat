							          ...
							          <div class="row">
							           <div class="col-md-6">
							            <div class="form-group bmd-form-group">
							              ...
							              <input type="text" class="form-control"  name="machinecode">
							            </div>
							          </div>
							           ...
							           <div class="col-md-6">
							            <div class="form-group bmd-form-group">
							              ...
							              <input type="number" step="0.1" class="form-control"  name="startingread">
							            </div>
							          </div>
							      </div>
							          ...
							          <div class="row">
							           <div class="col-md-6">
							            <div class="form-group bmd-form-group">
							              ...
							              <input type="number" step="0.1" class="form-control" name="endingread">
							            </div>
							         </div>

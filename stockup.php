<?php
	...
	if(isset($_POST['stock'])){
		...
		if(mysqli_query($conn, $sql)) {
                ...
                $sqlu = "UPDATE inventory SET qty = '$qty' and price='$price' WHERE gas = '$gas'";
			  	...
			  	<div class="card-body">
			    	<table class="table table-striped table-hover">
			    		<thead>
                           ...
                           <tbody>
								        			<?php
								        				$res = getData($conn, "stock");
								        				foreach ($res as $role) {
								        			?>
									          		<tr>
											            <td class="text-center"><?php echo $role['id']; ?></td>
											            <td><?php echo $role['edate']; ?></td>
											            <td><?php echo $role['gtype']; ?></td>
											            <td><?php echo $role['qty']; ?></td>
											            <td><?php echo $role['price']; ?></td>
											            <td><?php echo $role['note']; ?></td>
											            <td class="text-center td-actions">
												            
												            <a rel="tooltip" href="process/admin/usr_process.php?delstock=<?php echo $role['id']; ?>" class="btn btn-danger btn-link" title="Delete">
